...
<!-- topbar start -->
    ...
    <header class="container-fluid header-section d-none d-lg-block">
        <div class="container ">
            <nav>
                <div>
                    <img src="https://indiataxfile.com/wp-content/uploads/2024/01/logo.webp" width="180px"
                        alt="">
                </div>
                <ul>
                    <!-- Service Nav -->
    ...
    <!-- offcanvas mega menu start -->
     <section class="container-fluid offcanvas-menu-section d-lg-none " id="myHeader">
        <div class="container">
                            ...
                            <div class="m-accordion-item">
                                ...
                                <div class="m-accordion-content">
                                    <div>
                                        ...
                                        <span><i class="fa-regular fa-square-check"></i> Small and Medium Enterprises</span>
